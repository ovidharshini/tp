...
public class FinalizeCommandParserTest {

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, FinalizeCommand.MESSAGE_USAGE);
    ...
    public void parse_validArgs_success() {
        FinalizeCommand expected = new FinalizeCommand(Index.fromOneBased(3), new Employment());
