...
public class JobPeopleDeleteCommandTest {
    ...
    public void execute_nullModel_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> new DeleteCommand(Index.fromOneBased(1))
                .execute(null));
    }
    ...
    public void execute_incorrectArgs_throwsCommandException() {
        // No job at index 3
        DeleteCommand cmd = new DeleteCommand(Index.fromOneBased(3));
    ...
    public void execute_correctArgs_success() {
        ...
        model.addJob(JOB);
        DeleteCommand cmd = new DeleteCommand(Index.fromOneBased(1));
        assertCommandSuccess(cmd, model, String.format(DeleteCommand.MESSAGE_SUCCESS, JOB.getDesc()),
                expectedModel);
    }
}
