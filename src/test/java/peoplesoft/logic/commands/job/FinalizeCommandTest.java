...
public class FinalizeCommandTest {
    ...
    public void constructor_nullArgs_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> new FinalizeCommand(null, new Employment()));
        assertThrows(NullPointerException.class, () -> new FinalizeCommand(Index.fromOneBased(1), null));
    }

    @Test
    public void execute_nullModel_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> new FinalizeCommand(Index.fromOneBased(1), new Employment())
                .execute(null));
    }
    ...
    public void execute_incorrectArgs_throwsCommandException() {
        // No job at index 3
        FinalizeCommand cmd = new FinalizeCommand(Index.fromOneBased(3), new Employment());
    ...
    public void execute_correctArgs_success() {
        ...
        FinalizeCommand cmd = new FinalizeCommand(Index.fromOneBased(1), emp);
        assertCommandSuccess(cmd, model, String.format(FinalizeCommand.MESSAGE_SUCCESS, JOB.getDesc()),
                expectedModel);
    }
}
