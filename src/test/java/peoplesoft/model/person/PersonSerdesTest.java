...
public class PersonSerdesTest {
    ...
    public void deserialize_invalidName_throwsJsonMappingException() throws IOException {
        final String serialized = serializePerson(
            String.valueOf(1), INVALID_NAME, VALID_PHONE, VALID_ADDRESS, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_nullName_throwsJsonMappingException() {
        final String serialized = serializePerson(
            String.valueOf(1), null, VALID_PHONE, VALID_ADDRESS, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_invalidPhone_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, INVALID_PHONE, VALID_ADDRESS, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_nullPhone_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, null, VALID_ADDRESS, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_invalidEmail_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, VALID_PHONE, VALID_ADDRESS, INVALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_nullEmail_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, VALID_PHONE, VALID_ADDRESS, null, VALID_TAGS);
    ...
    public void deserialize_invalidAddress_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, VALID_PHONE, INVALID_ADDRESS, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_nullAddress_throwsJsonMappingException() {
        final String serialized = serializePerson(
                String.valueOf(1), VALID_NAME, VALID_PHONE, null, VALID_EMAIL, VALID_TAGS);
    ...
    public void deserialize_invalidTags_throwsJsonMappingException() {
        final String serialized = serializePerson(
            String.valueOf(1), VALID_NAME, VALID_PHONE, VALID_ADDRESS, VALID_EMAIL, INVALID_TAGS);
