...
public class AssignCommand extends Command {
    ...
    /**
     * Creates a {@code AssignCommand} to assign a {@code Job} to a set of {@code Person}s.
     *
     ...
     */
    public AssignCommand(Index jobIndex, Set<Index> personIndexes, Employment employment) {
    ...
    public boolean equals(Object other) {
        ...
        // state check
        AssignCommand c = (AssignCommand) other;
