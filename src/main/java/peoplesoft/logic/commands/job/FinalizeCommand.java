...
public class FinalizeCommand extends Command {
    ...
    /**
     * Creates a {@code FinalizeCommand} to finalize a {@code Job}.
     *
     * @param toFinalize Index of job to finalize.
     * @param instance Employment to use (for easier testing).
     */
    public FinalizeCommand(Index toFinalize, Employment instance) {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
            || (other instanceof FinalizeCommand // instanceof handles nulls
            && toFinalize.equals(((FinalizeCommand) other).toFinalize));
    }
}
